...
const resources = {
  en: {
    translation: {
      ...
      "crypto_processing_notice": "Your transaction is being processed and will be accepted automatically within a few minutes. If it is not verified, please submit a ticket to the admin via the support section in the user menu.",
  ...
  fa: {
    translation: {
      ...
      "Send the exact amount shown below to this wallet address.": "مبلغ دقیق نمایش‌داده‌شده را به این آدرس کیف پول واریز کنید.",
      "Copied to clipboard": "در کلیپ‌بورد کپی شد",
      "Copy failed": "کپی ناموفق بود",
      "Card number copied successfully.": "شماره کارت با موفقیت کپی شد.",
      ...
      "Send the equivalent value in BTC.": "معادل این مبلغ را به بیت‌کوین ارسال کنید.",
      "crypto_processing_notice": "تراکنش شما در حال پردازش است و طی چند دقیقه به‌صورت خودکار تأیید می‌شود. در صورت عدم تأیید، لطفاً از بخش پشتیبانی در منوی کاربری برای ادمین تیکت ثبت کنید.",
